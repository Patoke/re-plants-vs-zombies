...
void DataSync::SyncLong(int32_t& theNum)
{
	SyncLong((uint32_t&)theNum);
}
...
void DataSync::SyncShort(int32_t& theNum)
{
	SyncShort((unsigned short&)theNum);
}
...
void DataSync::SyncSShort(int32_t& theNum)
{
	SyncSShort((short&)theNum);
}
...
void DataSync::SyncByte(int32_t& theChar)
{
	SyncByte((unsigned char&)theChar);
}
...
void DataSync::SyncSByte(int32_t& theChar)
{
	SyncByte((char&)theChar);
}
