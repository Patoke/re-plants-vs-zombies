...
enum ReanimationType : unsigned int {
    ...
    REANIM_ZOMBIE_PEASHOOTER_HEAD,
    REANIM_ZOMBIE_JALAPENO_HEAD,
    REANIM_ZOMBIE_SQUASH_HEAD,
    REANIM_ZOMBIE_WALLNUT_HEAD,
    REANIM_ZOMBIE_TALLNUT_HEAD,
    REANIM_ZOMBIE_GATLING_PEA_HEAD,
    REANIM_PEASHOOTER_JALAPENO_FIRE,
    REANIM_BUTTER,
    REANIM_TANGLE_KELP_VINES,
    */
    REANIM_FLAG,
    REANIM_DANCER,
...
enum ZombatarCustomizationPage
{
    ZOMBATAR_CUSTOM_SKIN,
    ZOMBATAR_CUSTOM_CLOTHES,
    ZOMBATAR_CUSTOM_TIDBITS,
    ZOMBATAR_CUSTOM_ACCESSORIES,
    ZOMBATAR_CUSTOM_FACIAL_HAIR,
    ZOMBATAR_CUSTOM_HAIR,
    ZOMBATAR_CUSTOM_EYEWEAR,
    ZOMBATAR_CUSTOM_HATS,
    ZOMBATAR_CUSTOM_BACKDROPS,
    ZOMBATAR_NUM_ZOMBATAR_CUSTOM_PAGES,
    ZOMBATAR_CUSTOM_PAGE_START = 0,
    ZOMBATAR_PORTRAIT_DRAW_START
};
enum ReanimLoopType
{
    REANIM_LOOP = 0,
